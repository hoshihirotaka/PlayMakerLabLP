...
(window.EVENTS = window.EVENTS || []).push({
  ...
  comingSoon: true,
  note: "<strong>土曜はじめての開催です。</strong>日程と会場の時間帯が決まりました。各コースの時間・参加費・定員は調整中で、決まり次第このページでお知らせします。<br />13:00〜20:30の通し開催で、日中の回と夜の回をご用意する予定です。保護者様ご自身向けの大人向けAIコース（別イベント）も同日に開催します。",
  timetable: [
