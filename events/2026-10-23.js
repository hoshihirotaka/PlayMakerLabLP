...
//
// 金曜は「大人1＋子どもRoblox1」の2コマ（2026-09-08 定例）。標準形（SCHEDULE-PATTERNS.md §3）は
// 子ども2コマなので、②Roblox（18:20-19:20）を落とした形。空いた70分は休憩に充てている。
// ①が16:50始まりなのは、16:40だと18:20開始まで10分の空白ができるため。
// 19:30〜20:30（大人向け）と20:30終了は動かせないので、調整は先頭で吸収する。
// 「プログラミングあり」の記載は2026-09-08の定例で外した（分かりづらさの原因だった）。
(window.EVENTS = window.EVENTS || []).push({
  id: "2026-10-23",
  date: "2026年10月23日（金）",
  datetime: "2026年10月23日(金) 16:50-20:30",
  ...
  timetable: [
    { time: "16:50-17:50", label: "①Robloxコース", price: "3,000円" },
    { time: "17:50-18:20", label: "延長タイム・親御様個別相談" },
    // 金曜は子ども向け1コマなので、ここにまとまった休憩が取れる。
    // 日曜の派生案で13:30-14:30に休憩を置いたのと同じ考え方（通しで回すと休憩が消える）
    { time: "18:20-19:30", label: "休憩・設営" },
