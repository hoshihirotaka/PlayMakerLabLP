window.CURRICULUM = {
  "meta": {
    ...
    "sourceRepo": "LP編集（教材リポ E0-05-アバターモーション を取り込み）",
    "note": "このファイルはLPが編集する公開カタログ（source of truth）。教材リポジトリの curriculum-for-lp.md を元に、status・命名・タグ・公開可否はLPが確定する。掲載外の教材（PC基礎・公開とKPI・ボードゲーム）は科目タブに馴染まないため現状は非掲載。UEFNはEpic製ツールだが当面Roblox枠に置き表示名で明示。アバターモーション体験（E0-05）は体験用。既存のアバター変身（roblox-avatar・準備中）とは別教材。"
  },
  "materials": [
    {
      "id": "roblox-athletic",
    ...
    },
    {
      ...
      "icon": "👻",
      "sessions": 1,
      "summary": "暗さとライティングでこわい雰囲気を作る。",
      "detail": "暗い空間にモンスターや隠れ場所を置き、ライティングでこわい雰囲気を作るゲームです。プログラミングなしで「演出で怖さを作る」を体験します。",
      "status": "published"
    },
    {
      "id": "roblox-avatar-motion",
      "name": "アバターモーション体験",
      "subject": "Roblox",
      "tags": ["体験用", "クリエイティブ"],
      "icon": "💃",
      "sessions": 1,
      "summary": "動きとかぶりものでアバターを変身させる。",
      "detail": "歩き方の切り替え、おどり床でのモーション再生、パーツで帽子を作って装着まで体験します。色変えより「動き」で別人になる面白さが中心です。",
      "status": "published"
    },
    {
      "id": "roblox-uefn",
    ...
    },
    {
      ...
      "detail": "コインやアイテムを配置し、集めた数の表示・音のヒント・時間制限などをプログラムで作ります。「宝さがし体験」の本格版です。",
      "status": "published"
    },
    {
      "id": "roblox-party",
    ...
    },
    {
      ...
      "icon": "📦",
      "sessions": 12,
      "summary": "オブジェクトに変身して隠れる鬼ごっこを作る。",
      "detail": "オブジェクトに変身して隠れ、鬼が探す変身かくれんぼを、変身・チーム分け・発見・ラウンドまで1本作り切ります。",
      "status": "coming_soon"
    },
    {
      "id": "roblox-mechanics",
  ...
  "gaps": [
    {
      ...
      "tags": ["プログラミング"],
      "priority": 1,
      "reason": "体験会の「アクション」を楽しんだ子が次に進める、ギミックやスコアをプログラムで作る制作教材がない。体験→制作の穴が最も大きい（教材側も最優先の推し）。"
    },
    {
      ...
      "tags": ["プログラミング"],
      "priority": 2,
      "reason": "体験会の「レーシング」は人気だが、そこから本格的に作り込む続きの教材がない。既存メカニクスを流用しやすく比較的短工数で作れる見込み。"
    },
    {
      ...
      "tags": ["クリエイティブ"],
      "priority": 3,
      "reason": "AIのクリエイティブ教材は画像・音楽はあるが、動く映像（アニメ・動画）を作る教材がない。関心は高いが、利用ツールの年齢制限・安定性の見極めと運用ルール整備が必要。"
    }
  ]
}
;
